                ...
                with patch("eureka_lite.pipeline.train_rlvr", return_value={"final_loss": 0.5}) as train_mock:
                    summary = run_full_pipeline(
                        FullPipelineConfig(
                            ...
                            mjwarp_evaluator="ppo",
                            mjwarp_episode_steps=500,
                            mjwarp_policy_iterations=4,
                            mjwarp_ppo_horizon=32,
                            mjwarp_ppo_epochs=4,
                            mjwarp_ppo_minibatch_size=16_384,
                            mjwarp_ppo_learning_rate=3e-4,
                            mjwarp_elite_frac=0.1,
                            mjwarp_rollout_mode="gpu",
                            mjwarp_verified_evaluator="mjwarp",
                            mjwarp_verification_steps=1000,
                            mjwarp_batch_candidates=True,
                            mjwarp_cuda_graph=True,
