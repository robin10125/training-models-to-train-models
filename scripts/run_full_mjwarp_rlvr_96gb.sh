...
OUTPUT_DIR="${OUTPUT_DIR:-runs/deepseek_lite_ant_mjwarp_16x4096}"
ADAPTER_OUTPUT_DIR="${ADAPTER_OUTPUT_DIR:-runs/deepseek_lite_ant_mjwarp_grpo_adapter}"
...
PIPELINE_ARGS=(
  ...
  --task Ant-v5
  --model-id "$MODEL_ID"
  --collection-output-dir "$OUTPUT_DIR"
